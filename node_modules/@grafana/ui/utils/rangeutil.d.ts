...
export declare function getRelativeTimesList(timepickerSettings: any, currentDisplay: any): _.Dictionary<(number | {
    ...
    display: string;
    section: number;
}[]) => boolean, thisArg?: any) => boolean) | ((callbackfn: (value: {
    from: string;
    to: string;
    display: string;
    section: number;
    ...
    display: string;
    section: number;
}[]) => boolean, thisArg?: any) => number) | ((target: number, start: number, end?: number | undefined) => {
    from: string;
    to: string;
    display: string;
    section: number;
    ...
    display: string;
    section: number;
}]>) | (() => IterableIterator<number>) | ((searchElement: {
    from: string;
    to: string;
    display: string;
    section: number;
